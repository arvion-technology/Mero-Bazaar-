...
import type { MedicalListing, CreateMedicalPayload } from "@/app/types/medical";
...
export const api = {
  ...
  createMedical: (payload: CreateMedicalPayload) =>
    post<MedicalListing>('/api/medical', payload),
