...
export default function UnverifiedKYCPage() {
  const [activeTab, setActiveTab] = useState("unverified");
  const [sidebarOpen, setSidebarOpen] = useState(false);
  const [showAvatarDropdown, setShowAvatarDropdown] = useState(false);  // ← add this state
    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .admin-avatar-wrap { position: relative; }  /* ← add these avatar dropdown styles */
      ...
      <div className="admin-page">
        <aside className={`admin-sidebar ${sidebarOpen ? "mobile-open" : ""}`}>
          ...
          {/* ← REMOVED sidebar footer - avatar moved to topbar */}
        </aside>
        ...
        <main className="admin-main">
          <div className="admin-topbar">
            <div className="admin-topbar-left">
              ...
              <h1 className="admin-topbar-title">Unverified KYC</h1>
            </div>
          ...
          <div className="admin-section">
            <h2 className="admin-section-title">Pending KYC Applications</h2>
                ...
                <tbody>
                  {kycRows.map((kyc) => (
                    <tr key={kyc.id}>
                      ...
                      <td>
                        <Link href={`/admin/unverified/${kyc.id}`} className="admin-view-btn"><FiEye size={14} /> View</Link>
                      </td>
                    </tr>
                  ))}
                </tbody>
