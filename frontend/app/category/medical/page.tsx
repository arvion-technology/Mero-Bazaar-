  ...
  return (
    <>
      <style>{`
        ...
        /* ΓöÇΓöÇ MOBILE FILTER BAR ΓöÇΓöÇ */
          ...
          <div className="mp-layout">
            ...
            <div>
              ...
              <div className="mp-grid">
                {displayed.length === 0 ? (
                  <div className="mp-empty">
                    <div className="mp-empty-icon">≡ƒÅÑ</div>
              ...
              <div className="mp-grid">
                {loading ? (
                  <div className="mp-empty">
                    <div className="mp-empty-icon">ΓÅ│</div>
                    <p>Loading listingsΓÇª</p>
                  </div>
                ) : error ? (
                  <div className="mp-empty">
                    <div className="mp-empty-icon">ΓÜá∩╕Å</div>
                        ...
                        <div className="mp-card-header">
                          ...
                          <div className="mp-info">
                            ...
                            <div className="mp-badges">
                              {l.isVerified && <span className="mp-badge-verified">Γ£ô Verified</span>}
                            ...
                            <div className="mp-badges">
                              {m.verificationStatus === "VERIFIED" && <span className="mp-badge-verified">Γ£ô Verified</span>}
                        ...
                        <div className="mp-card-footer">
                          <div className="mp-footer-row">
                            ...
                            <div className="mp-status-badges">
                              {l.availableToday && <span className="mp-status-badge mp-status-avail">Γ£ô Available Today</span>}
                          ...
                          <div className="mp-book-btn">
                            ...
                            <div className="mp-status-badges">
                              {m.sameDayBooking && <span className="mp-status-badge mp-status-avail">Γ£ô Same-Day</span>}
