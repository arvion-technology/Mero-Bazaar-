...
export default function ListingInfo({
  ...
  useEffect(() => {
    ...
    fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/wishlist/check/${listingId}`,
      {
...
.ld-info-card:hover .ld-action-btns {
  opacity: 1;
  visibility: visible;
}
        `}
      ...
      <div className="ld-info-card">
        ...
        <div className="ld-specs-bar">
          ...
          <div className="ld-spec-chip">
            <div className="ld-spec-icon">
              <FiTag size={20} color="#2471A3" />
            </div>
            <span className="ld-spec-val" style={{ fontSize: 10 }}>
              {specs.model}
            </span>
          ...
          <div className="ld-spec-chip">
            <div className="ld-spec-icon">
              <FiCalendar size={20} color="#27AE60" />
            </div>
          ...
          <div className="ld-spec-chip">
            <div className="ld-spec-icon">
              <FiDroplet size={20} color="#F39C12" />
            </div>
          ...
          <div className="ld-spec-chip">
            <div className="ld-spec-icon">
              <TbManualGearbox size={20} color="#8E44AD" />
            </div>
            <span className="ld-spec-val" style={{ fontSize: 9.5 }}>
              {specs.transmission}
            </span>
