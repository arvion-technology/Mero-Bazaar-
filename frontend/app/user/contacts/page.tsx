    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .contacts-search:focus { border-color: #6366f1; box-shadow: 0 0 0 3px rgba(99,102,241,0.1); }

        .contacts-group-label { font-size: 12px; font-weight: 700; color: #94a3b8; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 10px; padding: 0 2px; }
        .contacts-card { background: #fff; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden; margin-bottom: 24px; width: 100%; }

        .contact-row { display: flex; align-items: center; gap: 14px; padding: 14px 20px; border-bottom: 1px solid #f8fafc; transition: background 0.15s; cursor: pointer; }
        .contact-row:hover { background: #fafbfc; }
        ...
        @media (max-width: 767px) {
          ...
          .contacts-search-wrap { max-width: 100%; }
          .contact-row { padding: 12px 16px; gap: 12px; }
        ...
        <div className="ud-main-area">
          ...
          <header className="ud-topbar">
            <div className="ud-topbar-left">
              ...
              <h1 className="ud-breadcrumb">Recent Contacts</h1>
            </div>
